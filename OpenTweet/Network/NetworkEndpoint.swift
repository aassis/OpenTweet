...
/// This is an Endpoint protocol to be used by our NetworkService, when declaring an enum as an endpoint, we can abstract a lot of information required by an http request.
