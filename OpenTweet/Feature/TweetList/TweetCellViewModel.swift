...
final class TweetCellViewModel: TweetCellViewModelProtocol {
    ...
    func tweetContent(fontSize: CGFloat) -> NSAttributedString {
        return self.highlightHandle(fromContentText: tweet.content, fontSize: fontSize)
    }
     ...
     */
    private func highlightHandle(fromContentText text: String, fontSize: CGFloat) -> NSAttributedString {
